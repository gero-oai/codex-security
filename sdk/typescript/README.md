...
npx @openai/codex-security scan /path/to/repository --patch --review-minimality
...
npx @openai/codex-security patch --scan SCAN_ID --review-minimality
...
Add `--review-minimality` to either patching workflow for an optional,
independent review that removes unnecessary or unrelated changes. The review is
disabled by default.
