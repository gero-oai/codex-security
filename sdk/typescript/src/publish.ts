...
export async function publishScanInternal(
  ...
  if (
    ...
    try {
      ...
      const detail = handoffResults.indeterminate
  ...
  for (const rawLine of content.split(/\r?\n/)) {
    ...
    if (
      ...
      evidence.push({
        ...base,
        status: "invalid",
        possibleMutation: record["possibleMutation"] === true || argumentsValid,
        error:
