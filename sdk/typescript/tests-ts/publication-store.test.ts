    ...
    const check = spawnSync(
      ...
      [
        ...
        [
          ...
          "for value in ['C:/state/workbench.sqlite3', '//server/share/state/workbench.sqlite3', '//?/C:/state/workbench.sqlite3', '//?/UNC/server/share/workbench.sqlite3']:",
          "    path = PureWindowsPath(value)",
          "    workbench.prepare_state_directory = lambda **_options: path.parent",
